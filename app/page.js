  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="products" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-black mb-4">ALL PRODUCTS</h2>
            <p className="text-gray-600 text-xl max-w-2xl mx-auto">
              ...
              <div>
                ...
                <div className="space-y-4 text-gray-600">
                  <p className="text-lg leading-relaxed">
                    ...
                    the forefront of bringing you the latest trends that define
                    the streets.
                  </p>
                  <p className="text-lg leading-relaxed">
                    Our journey started with a simple belief: everyone deserves
                    to express their unique style without compromise. We curate
